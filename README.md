# EyeOnian™ End User License Agreement & Terms of Service

Source for the GitHub Pages site at
<https://musicsolutionsllc.github.io/eyeonian-eula/>
...
4. In the app repo, re-vendor and bump the manifest:
   `python3 tools/vendor_legal.py --doc eula --version N.N --effective YYYY-MM-DD`
